...
void SmartHotelRobotCtrip::AuthorizeAccountPassword(CefRefPtr<CefBrowser> browser, CefRefPtr<CefFrame> frame, const CefString& url)
{
	std::thread([](CefRefPtr<CefBrowser> browser, CefRefPtr<CefFrame> frame, const CefString& url, SmartHotelRobotCtrip* robot) {
...
void SmartHotelRobotCtrip::AuthorizeAccountCode(CefRefPtr<CefBrowser> browser, CefRefPtr<CefFrame> frame, const CefString& url)
{
	std::thread([](CefRefPtr<CefBrowser> browser, CefRefPtr<CefFrame> frame, const CefString& url, SmartHotelRobotCtrip* robot) {
...
void SmartHotelRobotCtrip::HandleAuthorizeAccountPassword(const void* message_buffer, unsigned int message_length, void* answer_buffer, unsigned int answer_length)
{
...
void SmartHotelRobotCtrip::RedirectAccountLogin(CefRefPtr<CefBrowser> browser, CefRefPtr<CefFrame> frame, const CefString& url)
{
...
void SmartHotelRobotCtrip::DoAuthorizAccountPassword(CefRefPtr<CefBrowser> browser, CefRefPtr<CefFrame> frame, const CefString& url)
{
	std::string id = _context->GetCacheEnviromentId();
	std::string code_authorize_account = R"(
...
void SmartHotelRobotCtrip::DoAuthorizeCode(CefRefPtr<CefBrowser> browser, CefRefPtr<CefFrame> frame, const CefString& url)
{
