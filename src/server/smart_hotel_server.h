...
protected:
	...
	void OnHttpHandleRobotAuthorizeAccountPassword(const httplib::Request& req, httplib::Response& res);
...
protected:
	...
	int HandleRobotAuthorizeAccountPassword(const char* id, const char* password, unsigned int type, char* response, unsigned int response_length);
